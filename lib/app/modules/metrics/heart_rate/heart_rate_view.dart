      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const NoteCard(
              text:
                  'Letakkan jari telunjuk dan jari tengah di area nadi pergelangan tangan atau sisi leher, lalu hitung denyut selama 15 detik. Kalikan jumlah denyut dengan 4 untuk mendapatkan detak jantungmu.',
            ),
            SizedBox(height: verticalPadding),
            Row(
              children: [
