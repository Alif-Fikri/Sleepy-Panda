...
class OnboardingHeightView extends StatefulWidget {
  ...
  @override
  State<OnboardingHeightView> createState() => _OnboardingHeightViewState();
}

class _OnboardingHeightViewState extends State<OnboardingHeightView> {
  late final OnboardingHeightController controller;
  late FixedExtentScrollController wheelController;

  @override
  void initState() {
    super.initState();
    controller = Get.find<OnboardingHeightController>();
    final initialItem = (controller.selectedHeight.value - 100).clamp(0, 199);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        onPanEnd: (_) => controller.onHeightChanged(
                        ...
                        child: Container(
                          ...
                          child: ListWheelScrollView.useDelegate(
                            ...
                            onSelectedItemChanged: (index) {
                              ...
                              controller.onHeightChanged(height, context);
                            },
