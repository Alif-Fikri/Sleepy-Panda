...
import 'package:sleepys/app/widgets/charts/monthly/month_bar_chart.dart';
import 'package:sleepys/app/widgets/charts/monthly/month_sleep_time_line_chart.dart';
import 'package:sleepys/app/widgets/charts/monthly/month_wake_time_line_chart.dart';
import 'journal_monthly_controller.dart';

class JournalMonthlyView extends GetView<JournalMonthlyController> {
  const JournalMonthlyView({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Obx(() {
        ...
        final hasMonthData = data != null && data.isNotEmpty;
        final hasSummaryData = controller.hasMonthlySleepData;
        ...
        return ListView(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed:
                      controller.isLoading.value ? null : controller.nextMonth,
                ),
              ],
            ),
            if (error != null)
            ...
            _ChartContainer(
              child: hasMonthData
                  ? MonthBarChart(
                      sleepData: controller.weeklyDurations,
            ...
            _ChartContainer(
              child: hasMonthData
                  ? MonthLineChart(
                      data: controller.weeklySleepStartTimes,
                      startDate: controller.currentDate.value,
                    )
                  : _EmptyChartMessage(fontSize: baseFontSize),
            ),
            ...
            _ChartContainer(
              child: hasMonthData
                  ? MonthLineChart1(
                      data: controller.weeklyWakeTimes,
                      startDate: controller.currentDate.value,
                    )
                  : _EmptyChartMessage(fontSize: baseFontSize),
            ),
...
class _MonthlySleepEntryGrid extends StatelessWidget {
  const _MonthlySleepEntryGrid({
...
class _MonthlySleepEntry extends StatelessWidget {
  const _MonthlySleepEntry({
    required this.label,
    required this.title,
    required this.value,
    required this.asset,
